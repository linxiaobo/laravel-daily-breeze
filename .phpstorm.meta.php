...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','logging.default','logging.deprecations.channel',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','ide-helper.filename',
...
'web','api',);
        registerArgumentsSet('routes', 'dashboard','profile.edit','profile.update',
'profile.destroy','categories.index','categories.create','categories.store','categories.show',
'categories.edit','categories.update','categories.destroy','register',
...
'auth.verify-email','categories.edit','categories.index','components.application-logo','components.auth-session-status',
...
'components.text-input','dashboard','layouts.app','layouts.guest','layouts.navigation',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','welcome',
